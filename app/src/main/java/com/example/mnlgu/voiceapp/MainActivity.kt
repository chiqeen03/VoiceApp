package com.example.mnlgu.voiceapp
...
class MainActivity : AppCompatActivity() {
                ...
                Fuel.get("/query",
                    ...
                    .responseJson { _, _, result ->
                        ...
                        my_chat_view.send(Message.Builder()
                            .setRight(true)
                            .setUser(agent)
                            .setText(reply.getJSONObject("result").getJSONObject("fullfillment").getString("speech"))
                            .build()
                        )
                    }
            }
    ...
    companion object {
        private const val ACCESS_TOKEN = "2d6a9f310cf449d7b038960d9020c8002d6a9f310cf449d7b038960d9020c800"
